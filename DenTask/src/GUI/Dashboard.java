...
/**
 * Class responsible for representing dashboard items of Patient User Types
 * 
...
public class Dashboard {
	...
	private JComboBox<ComboItem> cboxAppointments;
	...
	private void initialize() {
		...
		/**************************************
		 * THIS IS FOR MAKE APPOINTMENTS PANE *
		 **************************************/
...
//				makeAppointment(String patient, String employee, String type, String detail, String date, int time)
	...
	/**
	 * Method to fill the employeeSelect combo box
	 * @param selectedMonth
	 * @param selectedDay
	 * @param selectedYear
	 * @param selectedTime
...
//			LinkedList<User> employeeSelectList(String dayOfWeek, String date, int time)
	...
	/**
	 * Fills the day combo box based on month and year
	 * @param selectedYear
	 * @param selectedMonth
	 */
